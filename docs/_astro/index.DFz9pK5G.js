...
T.cloneElement = function (e, n, t) {
  ...
  if (n != null) {
    if (
      (n.ref !== void 0 && ((u = n.ref), (o = Iu.current)),
...
var Uu = Ai.exports;
const pc = $i(Uu),
  kd = Ja({ __proto__: null, default: pc }, [Uu]);
var Gi = { exports: {} },
  ye = {},
  Zi = { exports: {} },
  Ji = {};
...
function Dc(e) {
  if (Ie && typeof Ie.onCommitFiberRoot == 'function')
    try {
      Ie.onCommitFiberRoot(qr, e, void 0, (e.current.flags & 128) === 128);
    } catch {}
}
var Le = Math.clz32 ? Math.clz32 : jc,
  ...
  Ic = Math.LN2;
function jc(e) {
  return (e >>>= 0), e === 0 ? 32 : (31 - ((Fc(e) / Ic) | 0)) | 0;
}
var rr = 64,
  lr = 4194304;
function gt(e) {
...
function ei() {
  Ct && (Ct.detachEvent('onpropertychange', Fs), (Ft = Ct = null));
}
function Fs(e) {
  if (e.propertyName === 'value' && el(Ft)) {
    var n = [];
    Os(n, Ft, e, Qu(e)), ms(kf, n);
  }
}
function Ef(e, n, t) {
  e === 'focusin'
    ? (ei(), (Ct = n), (Ft = t), Ct.attachEvent('onpropertychange', Fs))
    : e === 'focusout' && ei();
}
function Cf(e) {
...
var Me = typeof Object.is == 'function' ? Object.is : Pf;
function It(e, n) {
  if (Me(e, n)) return !0;
...
var du = typeof setTimeout == 'function' ? setTimeout : void 0,
  ...
  Ff =
    typeof queueMicrotask == 'function'
      ...
      : typeof si < 'u'
        ? function (e) {
            return si.resolve(null).then(e).catch(If);
          }
        : du;
function If(e) {
  setTimeout(function () {
...
function ao(e, n) {
  switch ((O(Vt, n), O(At, e), O(je, Zt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function pa(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), ll(4, 4, da.bind(null, n, e), t)
  );
}
function yo() {}
function ma(e, n) {
...
function ha(e, n, t) {
  return Pn & 21
    ? (Me(t, n) || ((t = Ss()), ($.lanes |= t), (Nn |= t), (e.baseState = !0)),
      n)
...
function xi(e, n, t, r, l) {
  ...
  if (((u = e.child), !(e.lanes & l))) {
    ...
    if (
      ((t = t.compare), (t = t !== null ? t : It), t(o, r) && e.ref === n.ref)
    )
      return Ke(e, n, l);
  }
  return (
...
function qf(e, n, t) {
  ...
  switch ((to(n), n.tag)) {
    ...
    case 5:
      ...
      if (((t = n.type), e !== null && n.stateNode != null))
        ...
        if (((e = Sn(je.current)), cr(n))) {
          ...
          switch (((r[Fe] = n), (r[$t] = u), (e = (n.mode & 1) !== 0), t)) {
            case 'dialog':
          ...
          switch (t) {
            ...
            case 'option':
              break;
            default:
              typeof u.onClick == 'function' && (r.onclick = Ir);
          }
    ...
    case 17:
      return fe(n.type) && jr(), ne(n), null;
    case 19:
      if ((F(U), (u = n.memoizedState), u === null)) return ne(n), null;
...
function Oa(e) {
  ...
  n !== null && ((e.alternate = null), Oa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[$t], delete n[pu], delete n[jf], delete n[Uf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Ho(t), n === 1))
      e.tag === 0 ? $f(Fi.bind(null, e)) : Ys(Fi.bind(null, e)),
        Ff(function () {
          !(R & 6) && mn();
        }),
        (t = null);
...
function gn(e, n, t) {
  var r = M,
    l = Ee.transition;
  try {
    (Ee.transition = null), (M = 1), id(e, n, t, r);
  } finally {
    (Ee.transition = l), (M = r);
  }
  return null;
...
var wd = Gi.exports;
const Sd = $i(wd);
export { pc as $, kd as a, Sd as b, wd as c, $i as g, Uu as r };
